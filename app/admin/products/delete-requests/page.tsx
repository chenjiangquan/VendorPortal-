...
export default async function AdminDeleteRequestsPage({ searchParams }: { searchParams: Promise<{ page?: string; limit?: string }> }) {
  ...
  return (
    <DashboardShell role="admin" title="Delete Requests">
      ...
      <Pagination page={page} limit={limit} total={count ?? 0} basePath="/admin/products/delete-requests" />
    </DashboardShell>
  );
}
